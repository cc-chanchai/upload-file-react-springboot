...
import UploadFilesService from '../service/UploadFileService'
    ...
    render() {
        ...
        return (
            <div>
                ...
                <label className="btn btn-defaul">
                    <input type="file" onChange={this.selectFile} />
                </label>
                <button className="btn btn-success" disabled={!selectedFiles} onClick={this.upload} > Uplaod </button>
